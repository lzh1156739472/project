...
public class NewsShiYeAdapter  extends BaseAdapter{
    private ArrayList<HomeShiYeBean.RecommendArticlesBean> list;
    private Context context;

    public NewsShiYeAdapter(ArrayList<HomeShiYeBean.RecommendArticlesBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HomeShiYeBean.RecommendArticlesBean recommendArticlesBean = list.get(position);
        switch (viewType) {
            case 32:
                if (convertView == null) {
                ...
                viewHolderPullDownRemaind.textView.setText(recommendArticlesBean.getTitle());
                break;
            ...
            case 1:
                ...
                viewHolderRithtLeft.textViewLeftTitile.setText(recommendArticlesBean.getTitle());
                Glide.with(context).load(recommendArticlesBean.getPics().get(0)).into(viewHolderRithtLeft.imageViewRightShow);
            ...
            case 2:
                ...
                viewHolderThreePic.textViewTitle.setText(recommendArticlesBean.getTitle());
                Glide.with(context).load(recommendArticlesBean.getPics().get(0)).into(viewHolderThreePic.imageViewLeft);
                Glide.with(context).load(recommendArticlesBean.getPics().get(1)).into(viewHolderThreePic.imageViewMiddle);
                Glide.with(context).load(recommendArticlesBean.getPics().get(2)).into(viewHolderThreePic.imageViewRight);
                break;
            case 0:
                if (convertView == null) {
