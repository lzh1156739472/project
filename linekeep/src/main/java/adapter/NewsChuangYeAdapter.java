...
public class NewsChuangYeAdapter extends BaseAdapter {
    private ArrayList<ChuangYeBean.ArticlesBean> list;
    private Context context;

    public NewsChuangYeAdapter(ArrayList<ChuangYeBean.ArticlesBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ChuangYeBean.ArticlesBean articlesBean = list.get(position);
        switch (viewType) {
            case 32:
                if (convertView == null) {
