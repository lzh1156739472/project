...
public class EcnomicAdapter extends BaseAdapter {
private ArrayList<EcnomicBean.ArticlesBean> list;
    private Context context;

    public EcnomicAdapter(ArrayList<EcnomicBean.ArticlesBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       EcnomicBean.ArticlesBean articlesBean = list.get(position);
        switch (viewType) {
            case 32:
                if (convertView == null) {
